...
class VCRate: UIViewController, SKStoreProductViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        openStoreProductWithiTunesItemIdentifier(identifier: CGlobal().identifierMiCalculadoraDePrestamos)
    }
